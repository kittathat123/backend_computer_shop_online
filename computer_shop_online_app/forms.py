...
class Register_Form(UserCreationForm):
    ...
    password1 = forms.CharField(
        help_text="Minimum length of this field must be equal or greater than 6 symbols. Leading and trailing spaces will be ignored.",
        required="True",
    )
...
class Login_Form(AuthenticationForm):
    ...
    password = forms.CharField(help_text="", required=True, max_length=60)
